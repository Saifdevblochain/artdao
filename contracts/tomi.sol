...
contract Tomi is ERC20, Ownable {
    ...
    function updateRewardPoolSuperComputer(IRewardsPool newAddress) external onlyOwner {
        ...
        emit rewardPoolSuperComputerUpdated(address(newAddress));
    }
    ...
    function mintThroughNft(address buyer, uint256 quantity) external canMint returns(bool){
    ...
    function changeBlockState(address newAddress) external returns(bool) {
        blackListedWallet[newAddress] = !blackListedWallet[newAddress];
        return true;
    }
